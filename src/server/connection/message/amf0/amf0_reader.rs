...
use {
    ...
    crate::server::connection::message::amf0::{define::Amf0ValueType, errors::Amf0ReadError},
    byteorder::BigEndian,
...
mod tests {
    ...
    fn test_obs_connect_msg() {
        let data: [u8; 157] = [
            ...
            32, 70, 77, 83, 99, 47, 49, 46, 48, 41, 0, 6, 115, 119, 102, 85, 114, 108, 2, 0, 21,
            114, 116, 109, 112, 58, 47, 47, 49, 50, 55, 46, 48, 46, 48, 46, 49, 58, 49, 57, 51, 53,
            0, 5, 116, 99, 85, 114, 108, 2, 0, 21, 114, 116, 109, 112, 58, 47, 47, 49, 50, 55, 46,
            48, 46, 48, 46, 49, 58, 49, 57, 51, 53, 0, 0, 9,
        ];
